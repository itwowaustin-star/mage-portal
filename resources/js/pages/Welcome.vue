...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center bg-gradient-to-br from-blue-50 to-white p-6 text-slate-900 lg:justify-center lg:p-8 dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800"
    >
        <header
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboard()"
                    class="inline-block rounded-sm border border-blue-200 px-5 py-1.5 text-sm leading-normal text-slate-900 hover:border-blue-400 dark:border-blue-600 dark:text-slate-100 dark:hover:border-blue-500"
                >
                    Dashboard
                </Link>
                <template v-else>
                    <Link
                        :href="login()"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-slate-900 hover:border-blue-200 dark:text-slate-100 dark:hover:border-blue-700"
                    >
                        Log in
                    </Link>
                    <Link
                        v-if="canRegister"
                        :href="register()"
                        class="inline-block rounded-sm border border-blue-200 px-5 py-1.5 text-sm leading-normal text-slate-900 hover:border-blue-400 dark:border-blue-700 dark:text-slate-100 dark:hover:border-blue-500"
                    >
                        Register
                    </Link>
                </template>
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-lg border border-blue-100 lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-slate-800 dark:text-slate-100 dark:border-slate-700"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-blue-200 dark:before:border-blue-700"
                        >
                            <span
                                class="relative bg-white py-1 dark:bg-slate-700"
                            >
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-blue-300 bg-blue-50 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-blue-600 dark:bg-slate-700"
                                >
                                    <span
                                        class="h-1.5 w-1.5 rounded-full bg-blue-500 dark:bg-blue-400"
                                    />
                                </span>
                            </span>
                            <span>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-blue-600 underline underline-offset-4 dark:text-blue-400"
                                >
                        ...
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-blue-200 dark:before:border-blue-700"
                        >
                            <span
                                class="relative bg-white py-1 dark:bg-slate-700"
                            >
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                class="inline-block rounded-sm border border-blue-600 bg-blue-600 px-5 py-1.5 text-sm leading-normal text-white hover:bg-blue-700 hover:border-blue-700 dark:border-blue-500 dark:bg-blue-500 dark:hover:bg-blue-400 dark:hover:border-blue-400"
                            >
                                Deploy now
                            </a>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-gradient-to-br from-blue-50 to-blue-100 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-gradient-to-br dark:from-blue-900 dark:to-slate-800"
                >
                    <svg
                        class="w-full max-w-none translate-y-0 text-blue-600 opacity-100 transition-all duration-750 dark:text-blue-500 starting:translate-y-6 starting:opacity-0"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <div
                        class="absolute inset-0 rounded-t-lg border border-blue-100 lg:overflow-hidden lg:rounded-t-none lg:rounded-r-lg dark:border-slate-700"
                    />
                </div>
            </main>
        </div>
